...
-(void)configUI{
    ...
    _textField.placeholder = @"输入真实姓名";
    _textField.clearButtonMode = UITextFieldViewModeAlways;
    _textField.text = _model.realName;
...
@"addr":_model.addr
 ...
 //ok
      _model.realName = _textField.text;
